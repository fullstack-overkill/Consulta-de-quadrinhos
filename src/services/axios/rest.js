import api from "../../containers/axios";
...
export default class Rest extends Service {
  ...
  getAll(url, params, config = {}) {
    return axios.get(this.resource + url, {
      params,
      ...config,
    });
  }
   ...
   */
  create(url, data) {
    return this.http.post(this.constructor.normalize(this.resource, url), data);
  }
